...
namespace UnityProjectArchitect.Services.AI
{
    public static class AIIntegrationTest
    {
        public static async Task<ValidationResult> RunBasicIntegrationTest()
        {
            try
            {
                Debug.Log("🧪 Starting AI integration test...");
                ...
                Debug.Log("✅ All AI integration tests passed successfully");
        ...
        private static ValidationResult TestAPIKeyManager()
        {
            try
            {
                Debug.Log("Testing API Key Manager...");
                ...
                Debug.Log("✅ API Key Manager test passed");
        ...
        private static ValidationResult TestResponseParser()
        {
            try
            {
                Debug.Log("Testing Response Parser...");
...
This document provides a comprehensive overview of the test system.";
                ...
                Debug.Log($"✅ Response Parser test passed - {parsed.WordCount} words, {parsed.Headings.Count} headings");
        ...
        private static ValidationResult TestClaudeAPIClient()
        {
            try
            {
                Debug.Log("Testing Claude API Client...");
                ...
                Debug.Log("✅ Claude API Client test passed");
        ...
        public static async Task<ValidationResult> TestWithMockAPI()
        {
            try
            {
                Debug.Log("🧪 Testing with mock API data...");
                ...
                Debug.Log($"Mock API Test Report:\n{report}");

                Debug.Log("✅ Mock API test completed successfully");
...
For more information, visit our [documentation site](https://docs.example.com).";
        ...
        public static void LogTestResults(ValidationResult result)
        {
            if (result.IsValid)
            {
                Debug.Log($"✅ Test Result: {result.Message}");
            }
            else
            {
                Debug.LogError($"❌ Test Failed: {result.ErrorMessage}");
            }
        }
    }
}