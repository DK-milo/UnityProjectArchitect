...
namespace UnityProjectArchitect.Services.AI
{
    public class APIKeyManager
    {
        ...
        public bool HasClaudeAPIKey()
        {
            ...
            {
                Debug.LogError($"Error checking Claude API key: {ex.Message}");
                return false;
            }
        }
        ...
        public string GetClaudeAPIKey()
        {
            try
            {
                ...
                {
                    Debug.LogWarning("Failed to decrypt Claude API key");
                    return null;
                }
                ...
                {
                    Debug.LogWarning("Claude API key integrity validation failed");
                    return null;
                }
            ...
            {
                Debug.LogError($"Error retrieving Claude API key: {ex.Message}");
                return null;
            }
        }
        ...
        public ValidationResult SetClaudeAPIKey(string apiKey)
        {
            ...
            try
            {
                ...
                Debug.Log("Claude API key successfully stored and encrypted");
        ...
        public void ClearClaudeAPIKey()
        {
            try
            {
                ...
                Debug.Log("Claude API key cleared successfully");
            }
            catch (Exception ex)
            {
                Debug.LogError($"Error clearing Claude API key: {ex.Message}");
            }
        }
        ...
        public DateTime? GetKeyCreationTime()
        {
            ...
            {
                Debug.LogError($"Error getting key creation time: {ex.Message}");
                return null;
            }
        }
        ...
        private void GenerateNewEncryptionKey()
        {
            ...
            {
                Debug.LogError($"Failed to generate encryption key: {ex.Message}");
                throw;
            }
        }
        ...
        private byte[] GetEncryptionKey()
        {
            ...
            {
                Debug.LogError($"Failed to retrieve encryption key: {ex.Message}");
                throw;
            }
        }
        ...
        {
#if UNITY_EDITOR
            return UnityEditor.EditorPrefs.GetString(key, string.Empty);
#else
        ...
        public void ClearAllKeys()
        {
            try
            {
                ...
                Debug.Log("All API keys and encryption data cleared");
            }
            catch (Exception ex)
            {
                Debug.LogError($"Error clearing all keys: {ex.Message}");
            }
        }
        ...
        public APIKeyStatus GetKeyStatus()
        {
            ...
            catch (Exception ex)
            {
                ...
                Debug.LogError($"Error getting key status: {ex.Message}");
            }
