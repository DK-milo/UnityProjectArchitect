...
namespace UnityProjectArchitect.Services
{
    public class PDFExporter : IExportFormatter
    {
        ...
        public List<ExportOption> GetAvailableOptions()
        {
            ...
            {
                new ExportOption("TemplateId", "Template", "default", "Template to use for PDF export"),
                new ExportOption("PageSize", "Page Size", "A4", "PDF page size: A4, Letter, Legal"),
                new ExportOption("Orientation", "Orientation", "Portrait", "Page orientation: Portrait, Landscape"),
                new ExportOption("IncludeHeaderFooter", "Include Header/Footer", true, "Add header and footer to pages"),
                new ExportOption("IncludePageNumbers", "Include Page Numbers", true, "Add page numbers"),
                new ExportOption("IncludeTOC", "Include Table of Contents", true, "Generate table of contents"),
                new ExportOption("FontFamily", "Font Family", "Arial", "Font family for body text"),
                new ExportOption("FontSize", "Font Size", "11", "Base font size in points"),
                new ExportOption("MarginTop", "Top Margin", "1in", "Top page margin"),
                new ExportOption("MarginBottom", "Bottom Margin", "1in", "Bottom page margin"),
                new ExportOption("MarginLeft", "Left Margin", "1in", "Left page margin"),
                new ExportOption("MarginRight", "Right Margin", "1in", "Right page margin"),
                new ExportOption("IncludeBookmarks", "Include Bookmarks", true, "Add PDF bookmarks for navigation"),
                new ExportOption("CompressImages", "Compress Images", true, "Compress embedded images"),
                new ExportOption("PrintOptimized", "Print Optimized", false, "Optimize for printing vs screen viewing")
            };
        }
