...
namespace UnityProjectArchitect.Services.ConceptAware
{
    ...
    public class ConceptualUserStoriesGenerator : BaseConceptAwareGenerator
    {
        ...
        {
            System.Console.WriteLine("[UnityProjectArchitect][AI DEBUG] ConceptualUserStoriesGenerator: Starting content generation");
            try
            {
            ...
            System.Console.WriteLine("[UnityProjectArchitect][AI DEBUG] Using offline fallback for ConceptualUserStoriesGenerator");
