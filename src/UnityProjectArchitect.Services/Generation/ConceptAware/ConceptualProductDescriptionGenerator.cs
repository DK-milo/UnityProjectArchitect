...
namespace UnityProjectArchitect.Services.ConceptAware
{
    ...
    public class ConceptualProductDescriptionGenerator : BaseConceptAwareGenerator
    {
        ...
        public override async Task<string> GenerateContentAsync()
        {
            ...
            System.Console.WriteLine("[UnityProjectArchitect][AI DEBUG] ConceptualProductDescriptionGenerator: Starting content generation");
            ...
            System.Console.WriteLine("[UnityProjectArchitect][AI DEBUG] Using offline fallback for ConceptualProductDescriptionGenerator");
