...
namespace UnityProjectArchitect.Core
{
    ...
    public static class ValidationServiceExtensions
    {
        ...
        {
            List<ValidationIssue> allIssues = new List<ValidationIssue>();
        ...
        public static string GetFormattedReport(this ValidationOperationResult result)
        {
            ...
            foreach (KeyValuePair<ValidationType, ValidationResult> kvp in result.ResultsByType)
            {
                ...
                if (validationResult.BlockerCount > 0)
                {
                    ...
                    foreach (ValidationIssue blocker in blockers)
                    {
